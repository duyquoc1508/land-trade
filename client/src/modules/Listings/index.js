              ...
              <div className="col-md-8">
                ...
                <div className="item-wrapper pt-40   ">
                  <div className="tab-content" id="myTabContent">
                    <div
                      className="tab-pane  fade property-grid"
                      id="grid-view"
                    >
                      <div className="row">
                        ...
                        <div className="col-xl-4 col-md-6 col-sm-12">
                          <div className="single-property-box">
                            <div className="property-item">
                              ...
                              >
                                <img
                                  src="images/property/property_5.jpg"
                                  alt="#"
                                />
                              </a>
                              <ul className="feature_text">
                              ...
                              <div className="property-author-wrap">
                                <a href="#" className="property-author">
                                  <img
                                    src="images/agents/agency_3.jpg"
                                    alt="..."
                                  />
                          ...
                          <div className="single-property-box">
                            <div className="property-item">
                              ...
                              <div className="property-author-wrap">
                                <a href="#" className="property-author">
                                  <img
                                    src="images/agents/agent_min_3.jpg"
                                    alt="..."
                                  />
                                  <span>Jim Carry</span>
                                </a>
                        ...
                        <div className="row">
                          ...
                          <div className="col-xl-8 col-lg-8 col-md-8">
                            <div className="property-title-box">
                              ...
                              <div className="trend-open mt-15">
                                <p>150.000.000 VNĐ</p>
                              </div>
